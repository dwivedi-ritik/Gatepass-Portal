...
export default function MaintenanceOverview(props) {
    ...
    let [maintenanceAreaChart, setMaintenanceAreaChart] = useState([])
    useEffect(() => {
        ...
        fetch('/api/maintenance/getDashboardChart')
            .then(res => res.json())
            .then(data => {
                setMaintenanceAreaChart(data)
            })
    }, [])
    if (!hydrated) {
        return <Spinner />
                    ...
                    <div className="flex mt-4 flex-col md:flex-row mx-4 md:space-x-3">
                        <div className="mt-4 w-full">
                            ...
                            <div className="mt-2 -ml-12">
                                <MaintenanceAreaChart chartData={maintenanceAreaChart} />
                            </div>
                        </div>
