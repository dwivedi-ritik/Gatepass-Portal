...
export default function SideNav(props) {
    ...
    return (
        <div className="h-screen bg-gray-800 sidenav hidden md:w-1/4 md:block transition-color">
            ...
            <div className="sidenav flex flex-col items-start">
                <Link href="/admin/gatepass/" prefetch={false}>
                    <div className="mt-8 flex h-12 w-full items-center justify-between overviews hover:bg-gray-700">
                ...
                <Link href="/admin/maintenance/" prefetch={false}>
                    <div className="flex items-center w-full maintenance hover:bg-gray-700 cursor-pointer">
