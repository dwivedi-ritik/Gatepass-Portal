...
export default function AdminRejecteds({ orgData, user }) {
        ...
        <div>
            ...
            <div className="flex">
                ...
                <div className="w-full ">
                    <div className="mx-4">
                        <AdminNav title={"Rejected Passes"} user={user} />
                    ...
                    <div className="overflow-x-auto sm:border sm:rounded-lg mt-8 mx-4 h-auto sm:max-h-[30rem]">
